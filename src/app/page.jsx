                ...
                <div className="container">
                    ...
                    <div className="row">
                        <div className="product-grid">
                            {homeData.orderDetailProducts.map((product, key) => (
                                product.isActive && (
                                        ...
                                        <div className="product-grid-item">
                                            <div className="single-product-wrapper">
                                                <div className="single-product-item">
                                                    ...
                                                    {homeData.orderDetailProducts.manageStock === 1 && homeData.orderDetailProducts.qty === 0 || homeData.orderDetailProducts.inStock === 0 ? (
                                                        <div className="product-promo-text style1 bg-danger">
                                                            <span>Stock Out</span>
                                                        </div>
                                                    ) : new Date() <= new Date(homeData.orderDetailProducts.newTo) ? (
